...
//
// Generated offline via opentype.js. "tusdi" is Space Grotesk Medium with
// -0.03em letter-spacing; the "AI" in tusdiAI is Outfit ExtraLight (200)
// with -0.045em letter-spacing, joined at natural advance on a shared
// baseline. Glyphs are flattened to SVG path data, normalized so x∈[0, w]
// and y∈[0, WORDMARK_H], in em-1000 units. y is SVG-style (top-down).
//
